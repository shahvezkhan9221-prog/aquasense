...
export default function Dashboard() {
  ...
  return <div className="relative z-[1] min-h-screen bg-background text-foreground">
    ...
    <aside className={`sidebar ${mobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}>
      ...
      <div className="mt-5 flex items-center gap-3 border-top-soft pt-5"><div className="avatar">TO</div><div className="min-w-0"><div className="truncate text-xs font-medium">Tarun Oli</div><div className="truncate text-[10px] text-muted-foreground">Network administrator</div></div><Settings2 className="ml-auto size-4 text-muted-foreground" /></div>
    </aside>
